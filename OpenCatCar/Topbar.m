...
- (void)setTitles:(NSMutableArray *)titles {
    ...
    for (int i = 0; i < titles.count; i++) {
        ...
        button.frame=CGRectMake(C+20, 0, button.intrinsicContentSize.width, 35);
        
        C+=button.intrinsicContentSize.width+40;
         //set button frame
...
//        originX      = CGRectGetMaxX(frame) + padding; //originX + padding + button.intrinsicContentSize.width;
    ...
    _markView.backgroundColor = [UIColor colorWithRed:255/255.0 green:248/255.0 blue:220/255.0 alpha:1];
