...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    // [self.navigationItemsetHidesBackButton:YES];   // 隐藏返回按钮
}
...
- (Topbar *)topbar {
    if (!_topbar) {
        ...
        _topbar.backgroundColor =[UIColor colorWithRed:50/255.0 green:120/255.0 blue:250/255.0 alpha:1];
      ...
      //self.navigationItem.titleView=_topbar;
